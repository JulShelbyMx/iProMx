const DATA = {
  universes: {
    ...
    'Saison 4':[
      ...
      {num:103,title:'GTA 5 RP À ZÉRO ! #4 - (Je prépare la plus grosse évasion !)',videoId:'ghROG6l29_w', youtubeLink:true},
// youtubeLink:true
     ],
}, },
...
{ id:'leconcierge', name:'Le concièrge', image:'https://ik.imagekit.io/ipromx/images/letigrebl/leconcierge.webp', banner:'https://ik.imagekit.io/ipromx/images/letigrebl/leconcierge-bannière.webp',
  ...
  notifications: {
    episode: {
      ...
      text: '(Jake Winters) : GTA 5 RP À ZÉRO ! #4 - (Je prépare la plus grosse évasion !)',
      link: {
        familyId: 'winters',
        charId:   'jake-winters',
        season:   'Saison 4',
