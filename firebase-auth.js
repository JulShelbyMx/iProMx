...
const PRESET_AVATARS = [
  { id:'av44',  src:'images/avatars/flashballelogo.png',  label:'Logo Flash'     },
  { id:'av1',  src:'images/avatars/letigrebl/david.png',  label:'David Flash'     },
  { id:'av3',  src:'images/avatars/letigrebl/john.png',  label:'John Flash'     },
  { id:'av5',  src:'images/avatars/letigrebl/poildecarotte.png',  label:'Poil de carotte'     },
  { id:'av6',  src:'images/avatars/letigrebl/ken.png',  label:'Ken Flash'     },
  { id:'av8',  src:'images/avatars/letigrebl/legeant.png',  label:'Le Géant Freddy'     },
  { id:'av9',  src:'images/avatars/letigrebl/tom.png',  label:'Tom Escobar 1'     },
  { id:'av9',  src:'images/avatars/letigrebl/agentx2ciné.png',  label:'Agent X 1'     },
  ...
  { id:'av9',  src:'images/avatars/letigrebl/tom-agentx.png',  label:'Tom et Agent X'     },
  { id:'av10',  src:'images/avatars/letigrebl/legenie.png',  label:'Le Génie'     },
  { id:'av11',  src:'images/avatars/letigrebl/aaron.png',  label:'Aaron Flash'     },
  { id:'av11',  src:'images/avatars/letigrebl/aaron2.png',  label:'Aaron Flash 2'     },
  { id:'av11',  src:'images/avatars/letigrebl/aaronmeditate.png',  label:'Aaron Flash 3'     },
  { id:'av11',  src:'images/avatars/letigrebl/aaron3.png',  label:'Aaron Flash 4'     },
  { id:'av15',  src:'images/avatars/letigrebl/davidjr.png',  label:'David JR Flash 1'     },
  { id:'av15',  src:'images/avatars/letigrebl/davidjr2.png',  label:'David JR Flash 2'     },
  { id:'av16',  src:'images/avatars/letigrebl/djrretourciné.png',  label:'David JR Flash 3'     },
  { id:'av18',  src:'images/avatars/letigrebl/damon.png',  label:'Damon Flash 1'     },
  { id:'av19',  src:'images/avatars/letigrebl/damonciné.png',  label:'Damon Flash 2'     },
  { id:'av19',  src:'images/avatars/letigrebl/damon3.png',  label:'Damon Flash 3'     },
  { id:'av21',  src:'images/avatars/letigrebl/billy.png',  label:'Billy'     },
  { id:'av22',  src:'images/avatars/letigrebl/monstrekayton_flash.png ',  label:'Kayton Flash 1'     },
  { id:'av23',  src:'images/avatars/letigrebl/kaytonretourciné.png',  label:'Kayton Flash 2'     },
  { id:'av23',  src:'images/avatars/letigrebl/kayton.png',  label:'Kayton Flash 3'     },
  { id:'av23',  src:'images/avatars/letigrebl/kaytonlg.png',  label:'Kayton Flash 4'     },
  { id:'av23',  src:'images/avatars/letigrebl/kaytonentrainement.png',  label:'Kayton Flash 5'     },
  { id:'av26',  src:'images/avatars/letigrebl/ryan.png',  label:'Ryan Johnson'     },
  { id:'av27',  src:'images/avatars/letigrebl/zakhackeur.png',  label:'Zak Hackeur'     },
  { id:'av28',  src:'images/avatars/letigrebl/ganggamins.png',  label:'Gang Gamins'     },
  { id:'av29',  src:'images/avatars/letigrebl/oliver.png',  label:'Oliver Winters'     },
  { id:'av30',  src:'images/avatars/letigrebl/adriannewflashciné.png',  label:'Adrian Flash 1'     },
  { id:'av30',  src:'images/avatars/letigrebl/adriandebut.png',  label:'Adrian Flash 2'     },
  { id:'av31',  src:'images/avatars/letigrebl/adrianprime2.png',  label:'Adrian Flash 3'     },
  { id:'av32',  src:'images/avatars/letigrebl/adriancasquette.png',  label:'Adrian Flash 4'     },
  { id:'av33',  src:'images/avatars/letigrebl/adrianinvitation.png',  label:'Adrian Flash 5'     },
  { id:'av33',  src:'images/avatars/letigrebl/adrian.png',  label:'Adrian Flash 6'     },
  { id:'av35',  src:'images/avatars/letigrebl/manda.png',  label:'Manda Flash'     },
  { id:'av35',  src:'images/avatars/letigrebl/manda2.png',  label:'Manda Flash 2'     },
  { id:'av36',  src:'images/avatars/letigrebl/leconcierge.png',  label:'Le concierge'     },
  { id:'av36',  src:'images/avatars/letigrebl/axeleret.png',  label:'Axel Leret'     },
  { id:'av37',  src:'images/avatars/letigrebl/ned-eden-eddy.png',  label:'Eden Ned Eddy'     },
  { id:'av37',  src:'images/avatars/letigrebl/edenteaser.png',  label:'Eden Flash 1'     },
  { id:'av37',  src:'images/avatars/letigrebl/edenfuitciné.png',  label:'Eden Flash 2'     },
  { id:'av37',  src:'images/avatars/letigrebl/eden2.png',  label:'Eden Flash 3'     },
  { id:'av38',  src:'images/avatars/letigrebl/nededeneddyprime.png',  label:'Ned Flash'     },
  { id:'av38',  src:'images/avatars/letigrebl/nedyeux.png',  label:'Ned Flash'     },
  { id:'av38',  src:'images/avatars/letigrebl/nedsouvenirs.png',  label:'Ned Flash'     },
  { id:'av38',  src:'images/avatars/letigrebl/latache.png',  label:'La tache'     },
  { id:'av39',  src:'images/avatars/letigrebl/nedprime.png',  label:'Ned Flash 2'     },
  { id:'av39',  src:'images/avatars/letigrebl/ned_flash.png',  label:'Ned Flash 3'     },
  { id:'av39',  src:'images/avatars/letigrebl/nedpose.png',  label:'Ned Flash 4'     },
  { id:'av39',  src:'images/avatars/letigrebl/zaynnedocean.png',  label:'Ned Flash 5'     },
  { id:'av40',  src:'images/avatars/letigrebl/eddyhumain.png',  label:'Eddy Flash 1'     }, 
  { id:'av40',  src:'images/avatars/letigrebl/eddyflash1.png',  label:'Eddy Flash 2'     }, 
  { id:'av40',  src:'images/avatars/letigrebl/eddy3.png',  label:'Eddy Flash 3'     }, 
  { id:'av43',  src:'images/avatars/letigrebl/jake.png',  label:'Jake Winters'     },  
  { id:'av45',  src:'images/avatars/shadelogologo.png',  label:'Logo Shade'     },
  //avatars à changer à partir d'ici avec nouveaux
  { id:'av46',  src:'images/avatars/letigrebl/sylvester-avatar.png',  label:'Sylvester Shade 1'     },
  { id:'av47',  src:'images/avatars/letigrebl/sylvester_shade.png',  label:'Sylvester Shade 2'     },
  { id:'av48',  src:'images/avatars/letigrebl/sylvester_shade.webp',  label:'Sylvester Shade 3'     },
  { id:'av49',  src:'images/avatars/letigrebl/zayn.png',  label:'Zayn Flash 1'     },
  { id:'av49',  src:'images/avatars/letigrebl/zaynteaser.png',  label:'Zayn Flash 2'     },
  { id:'av50',  src:'images/avatars/letigrebl/zack.png',  label:'Zack Kingsley'     },
