...
const PRESET_AVATARS = [
  { id:'av1',  src:'images/avatars/flashballelogo.webp',  label:'Logo Flash' },
  { id:'av2',  src:'images/avatars/letigrebl/david.webp',  label:'David Flash' },
  { id:'av3',  src:'images/avatars/letigrebl/john.webp',  label:'John Flash' },
  { id:'av4',  src:'images/avatars/letigrebl/poildecarotte.webp',  label:'Poil de carotte' },
  { id:'av5',  src:'images/avatars/letigrebl/ken.webp',  label:'Ken Flash' },
  { id:'av6',  src:'images/avatars/letigrebl/legeant.webp',  label:'Le Géant Freddy' },
  { id:'av7',  src:'images/avatars/letigrebl/tom.webp',  label:'Tom Escobar 1' },
  { id:'av8',  src:'images/avatars/letigrebl/agentx2ciné.webp',  label:'Agent X 1' },
  { id:'av9',  src:'images/avatars/letigrebl/agentx3ciné.webp',  label:'Agent X 2' },
  { id:'av10', src:'images/avatars/letigrebl/tomadulteciné.webp',  label:'Tom 2' },
  { id:'av11', src:'images/avatars/letigrebl/tom-agentx.webp',  label:'Tom et Agent X' },
  { id:'av12', src:'images/avatars/letigrebl/legenie.webp',  label:'Le Génie' },
  { id:'av13', src:'images/avatars/letigrebl/aaron.webp',  label:'Aaron Flash 1' },
  { id:'av14', src:'images/avatars/letigrebl/aaron2.webp',  label:'Aaron Flash 2' },
  { id:'av15', src:'images/avatars/letigrebl/aaronmeditate.webp',  label:'Aaron Flash 3' },
  { id:'av16', src:'images/avatars/letigrebl/aaron3.webp',  label:'Aaron Flash 4' },
  { id:'av17', src:'images/avatars/letigrebl/davidjr2.webp',  label:'David JR Flash 1' },
  { id:'av18', src:'images/avatars/letigrebl/davidjr.webp',  label:'David JR Flash 2' },
  { id:'av19', src:'images/avatars/letigrebl/djrretourciné.webp',  label:'David JR Flash 3' },
  { id:'av20', src:'images/avatars/letigrebl/damon.webp',  label:'Damon Flash 1' },
  { id:'av21', src:'images/avatars/letigrebl/damonciné.webp',  label:'Damon Flash 2' },
  { id:'av22', src:'images/avatars/letigrebl/damon3.webp',  label:'Damon Flash 3' },
  { id:'av23', src:'images/avatars/letigrebl/billy.webp',  label:'Billy' },
  { id:'av24', src:'images/avatars/letigrebl/monstrekayton_flash.webp',  label:'Kayton Flash 1' },
  { id:'av25', src:'images/avatars/letigrebl/kaytonretourciné.webp',  label:'Kayton Flash 2' },
  { id:'av26', src:'images/avatars/letigrebl/kayton.webp',  label:'Kayton Flash 3' },
  { id:'av27', src:'images/avatars/letigrebl/kaytonlg.webp',  label:'Kayton Flash 4' },
  { id:'av28', src:'images/avatars/letigrebl/kaytonentrainement.webp',  label:'Kayton Flash 5' },
  { id:'av29', src:'images/avatars/letigrebl/ryan.webp',  label:'Ryan Johnson' },
  { id:'av30', src:'images/avatars/letigrebl/zakhackeur.webp',  label:'Zak Hackeur' },
  { id:'av31', src:'images/avatars/letigrebl/ganggamins.webp',  label:'Gang Gamins' },
  { id:'av32', src:'images/avatars/letigrebl/oliver.webp',  label:'Oliver Winters' },
  { id:'av33', src:'images/avatars/letigrebl/adriannewflashciné.webp',  label:'Adrian Flash 1' },
  { id:'av34', src:'images/avatars/letigrebl/adriandebut.webp',  label:'Adrian Flash 2' },
  { id:'av35', src:'images/avatars/letigrebl/adrianprime2.webp',  label:'Adrian Flash 3' },
  { id:'av36', src:'images/avatars/letigrebl/adriancasquette.webp',  label:'Adrian Flash 4' },
  { id:'av37', src:'images/avatars/letigrebl/adrianinvitation.webp',  label:'Adrian Flash 5' },
  { id:'av38', src:'images/avatars/letigrebl/adrian.webp',  label:'Adrian Flash 6' },
  { id:'av39', src:'images/avatars/letigrebl/manda.webp',  label:'Manda Flash' },
  { id:'av40', src:'images/avatars/letigrebl/manda2.webp',  label:'Manda Flash 2' },
  { id:'av41', src:'images/avatars/letigrebl/leconcierge.webp',  label:'Le concierge' },
  { id:'av42', src:'images/avatars/letigrebl/axeleret.webp',  label:'Axel Leret' },
  { id:'av43', src:'images/avatars/letigrebl/ned-eden-eddy.webp',  label:'Eden Ned Eddy' },
  { id:'av44', src:'images/avatars/letigrebl/edenteaser.webp',  label:'Eden Flash 1' },
  { id:'av45', src:'images/avatars/letigrebl/edenfuitciné.webp',  label:'Eden Flash 2' },
  { id:'av46', src:'images/avatars/letigrebl/eden2.webp',  label:'Eden Flash 3' },
  { id:'av47', src:'images/avatars/letigrebl/nededeneddyprime.webp',  label:'Ned Flash 1' },
  { id:'av48', src:'images/avatars/letigrebl/nedyeux.webp',  label:'Ned Flash 2' },
  { id:'av49', src:'images/avatars/letigrebl/nedsouvenirs.webp',  label:'Ned Flash 3' },
  { id:'av50', src:'images/avatars/letigrebl/latache.webp',  label:'La tache' },
  { id:'av51', src:'images/avatars/letigrebl/nedprime.webp',  label:'Ned Flash 4' },
  { id:'av52', src:'images/avatars/letigrebl/ned_flash.webp',  label:'Ned Flash 5' },
  { id:'av53', src:'images/avatars/letigrebl/nedpose.webp',  label:'Ned Flash 6' },
  { id:'av54', src:'images/avatars/letigrebl/zaynnedocean.webp',  label:'Ned Flash 7' },
  { id:'av55', src:'images/avatars/letigrebl/eddyhumain.webp',  label:'Eddy Flash 1' }, 
  { id:'av56', src:'images/avatars/letigrebl/eddyflash1.webp',  label:'Eddy Flash 2' }, 
  { id:'av57', src:'images/avatars/letigrebl/eddy3.webp',  label:'Eddy Flash 3' }, 
  { id:'av58', src:'images/avatars/letigrebl/jake.webp',  label:'Jake Winters' },  
  { id:'av59', src:'images/avatars/shadelogologo.webp',  label:'Logo Shade' },
  { id:'av60', src:'images/avatars/letigrebl/silver1.webp',  label:'Sylvester Shade 1' },
  { id:'av61', src:'images/avatars/letigrebl/silver2.webp',  label:'Sylvester Shade 2' },
  { id:'av62', src:'images/avatars/letigrebl/silver3.webp',  label:'Sylvester Shade 3' },
  { id:'av63', src:'images/avatars/letigrebl/silver4.webp',  label:'Sylvester x La Mort 4' },
  { id:'av64', src:'images/avatars/letigrebl/silver5.webp',  label:'Sylvester Shade 5' },
  { id:'av65', src:'images/avatars/letigrebl/silver6.webp',  label:'Sylvester Shade 6' },
  { id:'av66', src:'images/avatars/letigrebl/silver7.webp',  label:'Sylvester Shade 7' },
  { id:'av67', src:'images/avatars/letigrebl/silver8.webp',  label:'Sylvester Shade 8' },
  { id:'av68', src:'images/avatars/letigrebl/lamort1.webp',  label:'La Mort 1' },
  { id:'av69', src:'images/avatars/letigrebl/lamort2.webp',  label:'La Mort 2' },
  { id:'av70', src:'images/avatars/letigrebl/lamort3.webp',  label:'La Mort 3' },
  { id:'av71', src:'images/avatars/letigrebl/zayn1.webp',  label:'Zayn Flash 1' },
  { id:'av72', src:'images/avatars/letigrebl/zayn2.webp',  label:'Zayn Flash 2' },
  { id:'av73', src:'images/avatars/letigrebl/zayn3.webp',  label:'Zayn Flash 3' },
  { id:'av74', src:'images/avatars/letigrebl/zayn4.webp',  label:'Zayn Flash 4' },
  { id:'av75', src:'images/avatars/letigrebl/zayn5.webp',  label:'Zayn Flash 5' },
  { id:'av76', src:'images/avatars/letigrebl/zayn6.webp',  label:'Zayn Flash 6' },
  { id:'av77', src:'images/avatars/letigrebl/zayn7.webp',  label:'Zayn Flash 7' },
  { id:'av78', src:'images/avatars/letigrebl/zayn8.webp',  label:'Zayn Flash 8' },
  { id:'av79', src:'images/avatars/letigrebl/zayn9.webp',  label:'Zayn Flash 9' },
  { id:'av80', src:'images/avatars/letigrebl/zack.webp',  label:'Zack Kingsley' }
];
